...
- [x] **INTE-05**: User can clearly tell which project/workspace a terminal tab belongs to
...
- [x] **TERM-02**: Terminal output and prompt layout remain correct when the panel size changes
